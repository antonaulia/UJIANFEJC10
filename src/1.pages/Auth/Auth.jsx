...
import {onLogin, onRegister, caricartLength} from './../../redux/1.actions'
...
class Auth extends Component {
    state = {
        page : this.props.match.params.cekcok,
        registerUsername : '',
        registerPassword : '',
        repeatPassword : '',
        registerEmail : '',
...
export default connect(mapStateToProps, {onLogin, onRegister,caricartLength})(Auth);